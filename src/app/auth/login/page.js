        ...
        <div className="hidden md:flex md:w-1/2 relative bg-primary overflow-hidden items-center justify-center">
          ...
          <div className="relative z-10 p-16 flex flex-col gap-8 max-w-xl">
            ...
            <p className="text-white/80 text-lg md:text-xl font-medium leading-relaxed">
              Log in to manage your shop, discover new favorites, and support
              your neighbors.
            </p>
            <div className="flex items-center gap-5 mt-4">
              <div className="flex -space-x-3">
                ...
                <img
                  ...
                  alt="Community member"
                />
                <div className="w-12 h-12 rounded-full border-2 border-white bg-primary flex items-center justify-center text-xs text-white font-black">
                  +5k
                </div>
              </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 md:px-24 bg-white dark:bg-slate-900">
          <div className="w-full max-w-[440px] flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              <h1 className="text-slate-900 dark:text-white text-[32px] font-black leading-tight">
                Welcome back
              </h1>
            ...
            <button
              ...
              className="flex w-full items-center justify-center rounded-2xl h-14 px-5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white gap-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-200 font-bold text-base shadow-sm active:scale-[0.99]"
            >
            ...
            <div className="relative flex items-center">
              ...
              <span className="flex-shrink mx-4 text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">
                or with email
              </span>
              <div className="flex-grow border-t border-slate-100 dark:border-slate-800"></div>
            </div>
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center ml-1">
                  <label className="text-xs font-bold text-red-500 dark:text-red-400 uppercase tracking-wider">
                    {error}
                  </label>
                </div>
              </div>
