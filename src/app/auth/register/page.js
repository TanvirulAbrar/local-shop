        ...
        <div className="hidden md:flex md:w-1/2 relative bg-primary overflow-hidden items-center justify-center">
          ...
          <div className="relative z-10 p-16 flex flex-col gap-8 max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/20 backdrop-blur-md rounded-full w-fit">
              ...
              <span className="text-white text-xs font-bold uppercase tracking-wider">Live Community</span>
            </div>
            <h1 className="text-white text-4xl md:text-6xl font-extrabold leading-[1.1] tracking-tight">
              Grow your business with your neighbors.
            </h1>
            <p className="text-white/80 text-lg md:text-xl font-medium leading-relaxed">
              Connect with local buyers and fellow artisans. We provide the tools; you provide the craft.
            </p>
            <div className="flex items-center gap-5 mt-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white/60 text-sm">Joined this month</span>
              </div>
            </div>
          </div>
        </div>
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 md:px-24 bg-white dark:bg-slate-900">
          <div className="w-full max-w-[440px] flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              <h1 className="text-slate-900 dark:text-white text-[32px] font-black leading-tight">Create account</h1>
              <p className="text-slate-500 dark:text-slate-400 text-base font-medium">Join our community marketplace today</p>
            </div>
            ...
            <form className="flex flex-col gap-5">
              ...
              <div className="flex items-start gap-3 mt-1">
                <input 
                  className="mt-1 size-5 rounded-lg border-slate-300 text-primary focus:ring-primary/20 transition-all cursor-pointer" 
                  id="terms" 
                  type="checkbox"
                />
                <label className="text-sm text-slate-500 dark:text-slate-400 leading-snug cursor-pointer select-none" htmlFor="terms">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
                ...
                <Link className="text-primary font-black hover:underline ml-1" href="/auth/login">Log in here</Link>
              </p>
            </div>
          </div>
        </div>
