...
export default async function ProductDetailPage({ params }) {
  ...
  const res = await fetch(`${process.env.NEXT_PUBLIC_SERVER}/data.json`);
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="w-full lg:w-[55%] xl:w-[60%] px-6 md:px-12 py-8 space-y-8">
            <div className="mb-4">
              <Link
                href="/products"
                className="inline-flex items-center gap-2 text-slate-400 hover:text-primary transition-all group"
              >
              ...
              <div className="flex gap-4 overflow-x-auto no-scrollbar pb-4 -mx-2 px-2">
                <div className="relative flex-none w-40 aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer group shadow-lg ring-2 ring-primary">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("https://lh3.googleusercontent.com/aida-public/AB6AXuB3ARr5I5uLX8JzHMejDpbVt8yPHTbhgdwjpJtFzoMegSm97Bsrtm12Q5sQRC1FTr3L2QIuuoAjxRm--7loYBYicBbtWGkCA8pqX8cpVcih4WrMD5X0nOlfk8klS8ZJV6VIXCeHLpT3EsUCAj103msfG31_qoK4c-nywM1CHsa9J_j9WM3oSPmI_Do0jjuNnemfFzoL0tu9ztIp2epGutY20imxyapxwrL95zTY1VlriLVqyn8SSYAMvF-1jS7zq9tJiV9h1mEBfxBv")',
                    }}
                  ></div>
                  <span className="absolute bottom-3 left-3 z-20 text-[10px] font-bold text-white uppercase tracking-wider">
                    The Wheel
                  </span>
                </div>
                <div className="relative flex-none w-40 aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer group shadow-md opacity-80 hover:opacity-100 transition-opacity">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCJn0T6n39_wDmAgfnpeT3jL23u3OQRcwgjSHftdzGhPQOU2C3iwiLsIBcEjHA99o1g9kAq1b9DSiqsEBHR7UYm4LI_y54_6Biv5xHnWKjET0j8Zfw8fx4LL4aFkE8obnFSppo4FnxqJkXsw8qSTr9F5BjDHn8_qPvG0N90Vkp8YUajizkTQsxY39_5IjoZEeNVw1Vlvkl0E8ZOg8TLdoGqRbU3LwQK5-rWI5q_fbHsoH5LBPYVvvP3SIxq-AB_obvc22KM7T6UQquM")',
                    }}
                  ></div>
                  <span className="absolute bottom-3 left-3 z-20 text-[10px] font-bold text-white uppercase tracking-wider">
                    Glazing
                ...
                <div className="relative flex-none w-40 aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer shadow-md opacity-80 hover:opacity-100 transition-opacity">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDBXjX8T3MqPyNTVQe56lfBWQgNC7ekaFY_6Z86rV35aoRparunxvfwN29Ye_DXAcFkCPc_A82Nj3teC1_JezhI-wObk-11y2rG05V4_4vH1Fiy701Z1vE39l1gNU0UZfLyuUZGKMbnyi_rN3o7eftwlgCY1IOUNmJdlx3abVNBqTtaICjQPwtXeLSBm-LR4W__ckPJCtV9B7UPMYC7oqH4BoyeevFpQBa_7Pg7KBZTJtTOIpBK5ZX83MpSlrKp4-HN9fuGzOMYmlnq")',
                    }}
                  ></div>
                </div>
              </div>
            ...
            <div className="lg:sticky lg:top-[72px] p-6 md:p-12 space-y-8">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <span className="px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-primary bg-primary/10 rounded-full">
                    Limited Edition
                  </span>
                  <span className="px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-slate-500 bg-slate-200 dark:bg-slate-800 rounded-full">
                    Sustainable
                  </span>
                </div>
                <h1 className="text-4xl xl:text-5xl font-black text-slate-900 dark:text-white leading-tight tracking-tight">
                  {product.name}
                </h1>
                <div className="flex items-center gap-3 group cursor-pointer w-fit">
                  ...
                  <div>
                    ...
                    <p className="text-slate-900 dark:text-white font-bold group-hover:text-primary transition-colors">
                      Oak Grove Pottery
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex justify-between items-baseline">
                    <div className="flex flex-col">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em] mb-1">
                        Current Price
                      </span>
